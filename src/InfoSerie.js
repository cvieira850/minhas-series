...
const InfoSerie = ({match}) => {
  ...
  useEffect(() => {
    ...
    .then(res => {
      ...
      const genresTeste = res.data.data 
      const encontrado = genresTeste.find( value => data.genre === value.name)
        ...
        <div className='container'>
          ...
          <form>
            ...
            <div className='form-group'>
              ...
              <select className='form-control' value={genreId} id='genrer' onChange={changeGenreId}>
                { genres.map(genre => 
                  <option key={genre.id} 
                    value={genre.id}
            ...
            <div className='form-check'>
              ...
              <label className='form-check-label' htmlFor='assistido' type='radio' >
                Assistido
              </label>
            </div>
            <div className='form-check'>
              ...
              <label className='form-check-label' htmlFor='paraAssistir' type='radio'  >
                Para assistir
              </label>
            </div>
